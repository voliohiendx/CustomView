...
import com.example.custtomview.databinding.ActivityExoPlayerBinding
...
class ExoPlayerActivity : AppCompatActivity() {
    ...
    private fun initEpoxy(list: List<String>) {
        PagerSnapHelper().attachToRecyclerView(binding.rvTest)
        binding.rvTest.withModels {
